...
enum ScrollableBottomNavigationBarType {
...
///     ),
///    ScrollableBottomNavigationBar:ScrollableBottomNavigationBar(
///       items: const <BottomNavigationBarItem>[
///        ScrollableBottomNavigationBarItem(
...
class ScrollableBottomNavigationBar extends StatefulWidget {
  ...
  final ScrollableBottomNavigationBarType type;
...
class _BottomNavigationBarState extends State<ScrollableBottomNavigationBar>
  ...
  ScrollableBottomNavigationBarType get _effectiveType {
    return widget.type ??
        BottomNavigationBarTheme.of(context).type ??
        (widget.items.length <= 3
            ? ScrollableBottomNavigationBarType.fixed
            : ScrollableBottomNavigationBarType.shifting);
  }
